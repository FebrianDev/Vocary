        ...
        setContent {
            VocaryTheme {
                Scaffold(
                    ...
                    val sortType by historyViewModel.sortType.collectAsState()
                    val sortOrder by historyViewModel.sortOrder.collectAsState()

                    val loadingShimmer by historyViewModel.loadingShimmer.collectAsState()
                    ...
                    LaunchedEffect(searchText) {
                        if (searchText.isBlank()) {
                            ...
                            delay(300)
                            historyViewModel.searchHistory(searchText)
                        }
                    }

                    val history by historyViewModel.vocabs.collectAsState()
                        ...
                        LazyColumn(
                            ...
                            if (loadingShimmer) {
                                ...
                                if (history.isEmpty()) {
                                    ...
                                    itemsIndexed(history) { i, vocabulary ->
                    ...
                    if (showSortSheet) {
                        SortBottomSheet(
                            ...
                            onSortChange = { type, order ->
                                historyViewModel.updateSort(type, order)
                                showSortSheet = false
                            },
